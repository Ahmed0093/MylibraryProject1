...
//    }
    private void initControl(Context context) {
      ...
      view=  inflater.inflate(R.layout.mylibraryview, this);
        ...
        txtDate.setOnClickListener(txtDateClickListener);

        this.ctx=context;
    }

    private final View.OnClickListener txtDateClickListener = new View.OnClickListener() {

        @Override
        public void onClick(View view) {
            textListener= (TextListener) getCtx();
            textListener.onTextClked();
        }
    };
